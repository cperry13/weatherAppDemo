...
//update the value of the test in message1 id
//message1.textContent = 'Testing...';

//add action to the form
weatherForm.addEventListener('submit', (e) => {
	e.preventDefault(); //keeps the page form refreshing when the button is clicked
	//console.log('testing');
	...
	response.json().then((data) => {
		...
		else
		{
			...
			currentTemp.textContent = data.weather.currentTemp + "ºF";
			message3.textContent = "Feels Like Temperature: ";
			feelsLikeTemp.textContent = data.weather.feelsLikeTemp + "ºF";
